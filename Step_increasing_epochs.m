...
for j=1:2000 % number of runs
    ...
    neurons=1000; initialradius=neurons/5;
    epochs=j;
...
save(sprintf('densities%d.mat',j)); %Saving all the experiment
...
% save(sprintf('increasing_epochs%d.mat',j)); %Saving all the experiment
